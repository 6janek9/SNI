...
\section{Úkol 2 - Součinitele deformační citlivosti}
    ...
    \subsection{Teoretický rozbor}
        ...
        \printfigure[Přístroj pro cejchování tenzometrů~\cite{navod}]{src/cejch.png}{0.65}{cejch}
            \pagebreak
    \subsection{Postup měření}
    ...
    Součinitel deformační citlivosti $E$ byl z naměřených hodnot určen jako $E = 2.160$, což je o cca $10\%$ více, než je katalogová hodnota~\cite{navod}.
...
\section{Úkol 6 - Nejistota výstupního napětí}
    ...
    Pro výpočet celkové nejistoty je nutné jednotlivé nejistoty vynásobit citlivostními koeficienty $A$. Jejich výpočet je parciální derivací vztahu (\ref{mustek}) podel jednotlivýh veličin, do kterých se dosadí hodnoty z tabulky \ref{tab:nejistota6}. 
    \begin{align*}
